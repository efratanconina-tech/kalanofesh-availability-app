...
set
  cover_image_url = '/media/complexes/boutique-hamayan/cover.jpg',
  video_url = '/media/complexes/boutique-hamayan/video-tour.mp4',
...
cross join (
  values
    ('00000000-0000-4000-8000-000000000301'::uuid, '2026-07-17'::date, '2026-07-19'::date, 'booked', 'תפוס לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000302'::uuid, '2026-07-24'::date, '2026-07-26'::date, 'booked', 'תפוס לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000303'::uuid, '2026-08-05'::date, '2026-08-06'::date, 'booked', 'תפוס לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000304'::uuid, '2026-08-09'::date, '2026-08-13'::date, 'booked', 'תפוס לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000305'::uuid, '2026-08-14'::date, '2026-08-16'::date, 'booked', 'תפוס לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000306'::uuid, '2026-08-21'::date, '2026-08-23'::date, 'booked', 'תפוס לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000307'::uuid, '2026-09-04'::date, '2026-09-06'::date, 'booked', 'תפוס לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000308'::uuid, '2026-09-11'::date, '2026-09-13'::date, 'booked', 'תפוס ראש השנה לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000309'::uuid, '2026-09-18'::date, '2026-09-20'::date, 'booked', 'תפוס לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000310'::uuid, '2026-09-25'::date, '2026-09-27'::date, 'booked', 'תפוס חג סוכות לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000311'::uuid, '2026-10-02'::date, '2026-10-04'::date, 'booked', 'תפוס חג סוכות לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000312'::uuid, '2026-10-09'::date, '2026-10-11'::date, 'booked', 'תפוס לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000313'::uuid, '2026-10-16'::date, '2026-10-18'::date, 'booked', 'תפוס לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000314'::uuid, '2026-10-23'::date, '2026-10-25'::date, 'booked', 'תפוס לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000315'::uuid, '2026-10-30'::date, '2026-11-01'::date, 'booked', 'תפוס לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000316'::uuid, '2026-11-06'::date, '2026-11-08'::date, 'booked', 'תפוס לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000317'::uuid, '2027-11-12'::date, '2027-11-14'::date, 'booked', 'תפוס לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000318'::uuid, '2026-11-20'::date, '2026-11-22'::date, 'booked', 'תפוס לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000319'::uuid, '2026-11-27'::date, '2026-11-29'::date, 'booked', 'תפוס לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000320'::uuid, '2026-12-11'::date, '2026-12-13'::date, 'booked', 'תפוס לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000321'::uuid, '2026-12-25'::date, '2026-12-27'::date, 'booked', 'תפוס לפי רשימת אחוזה בהר'),
    ('00000000-0000-4000-8000-000000000322'::uuid, '2026-07-31'::date, '2026-08-02'::date, 'booked', 'תפוס בשבתות שבין הרשימה באחוזה בהר'),
    ('00000000-0000-4000-8000-000000000323'::uuid, '2026-08-07'::date, '2026-08-09'::date, 'booked', 'תפוס בשבתות שבין הרשימה באחוזה בהר'),
    ('00000000-0000-4000-8000-000000000324'::uuid, '2026-08-28'::date, '2026-08-30'::date, 'booked', 'תפוס בשבתות שבין הרשימה באחוזה בהר'),
    ('00000000-0000-4000-8000-000000000325'::uuid, '2026-11-13'::date, '2026-11-15'::date, 'booked', 'תפוס בשבתות שבין הרשימה באחוזה בהר'),
    ('00000000-0000-4000-8000-000000000326'::uuid, '2026-12-04'::date, '2026-12-06'::date, 'booked', 'תפוס בשבתות שבין הרשימה באחוזה בהר'),
    ('00000000-0000-4000-8000-000000000327'::uuid, '2026-12-18'::date, '2026-12-20'::date, 'booked', 'תפוס בשבתות שבין הרשימה באחוזה בהר')
) as blocks(block_id, start_date, end_date, status, note)
where complexes.slug = 'achuzah-bahar'
on conflict (id) do update set
  start_date = excluded.start_date,
  end_date = excluded.end_date,
  status = excluded.status,
